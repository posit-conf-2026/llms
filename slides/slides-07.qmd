...
👨‍💻 [_demos/15_demo_manual-tools/15_demo_manual-tools-app.R]{.code .b .purple}

## Wait... I can write code! {.center}

👨‍💻 Work through the script to register the tool, then run the app to see it in action

👨‍💻 [_demos/16_demo_tools/16_weather-tool-01-start.R]{.code .b .purple} → [_demos/16_demo_tools/16_weather-tool-app.R]{.code .b .purple}

👨‍💻 [_demos/16_demo_tools/16_weather-tool-01-start.py]{.code .b .purple} → [_demos/16_demo_tools/16_weather-tool-app.py]{.code .b .purple}
