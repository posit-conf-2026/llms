...
## Artificial Analysis ([artificialanalysis.ai](https://artificialanalysis.ai/leaderboards/models))

![](assets/artificial-analysis.png){alt="Screenshot of the Artificial Analysis website home page, showing independent rankings of AI models by intelligence, speed, and cost per task." style="max-width: 90%; max-height: 72vh; display: block; margin: 0 auto;"}
