...
## Positron: Get the latest updates {.no-invert-dark-mode background-image="assets/git-pull-positron.png" background-size="100%" background-position="center 200px"}

* Open git panel, git fetch, then sync changes
* Or **Git: Pull** in Command Palette

## Rstudio: Get the latest updates {.no-invert-dark-mode background-image="assets/git-pull-rstudio.png" background-size="100%" background-position="center 200px"}
