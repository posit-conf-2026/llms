...
* Join the Discord: [pos.it/joinconf26]({{< meta workshop.links.discord >}}){.code .orange .b}
...
::: col
1. Open [pos.it/joinconf26]({{< meta workshop.links.discord >}})
...
## How API access usually works {.center}

::: {.incremental .mt4}
1. 🆙 Sign up with a model provider (OpenAI, Anthropic, etc.)

2. 💳 Add a payment method or use organizational access

3. 🔑 Create an API key or use another sign-in method

4. 💾 Store your credentials securely
:::

## Today, we'll use Posit AI Pass {.center}

::: incremental
<!-- TODO: sign in instructions --> 
:::

## Set up Posit Assistant

<!-- TODO: Posit Assistant setup instructions -->
...
🤖 Open Posit Assistant and paste in the following instructions:

I'm just starting the posit::conf LLM workshop. Point me to the first exercise (`01_hello-llm`), explain the purpose to me, and tell me how to complete it. 


Once you've successfully chatted with Posit Assistant and run the code in `01_hello-llm`, you're done!
:::
