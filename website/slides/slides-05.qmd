...
1. Run the eval.
   It grades Gemma 4 26B and Claude Haiku 4.5 on the same explanation rubric.

1. Open the viewer.
   Compare the responses and the grader's explanations.

1. Which model followed the rubric better?
...
A deterministic scorer could count sentences.
This eval uses a model grader because the rubric also asks whether each response is accurate, clear, and concrete.
:::
