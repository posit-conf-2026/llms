...
1. Run the eval.
   It grades Kimi K3 and Claude Haiku 4.5 on a two-sentence formatting rule.

1. Open the viewer.
   Compare the responses and the scores.

1. Which model followed the format better?

1. Did the grader ever disagree with you?
