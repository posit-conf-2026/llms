...
- (10m) Evals
  - Briefly introduce datasets, solvers, and scorers
  - Show `vitals` for R and chatlas with Inspect for Python
  - Activity: compare three prompts on plots with and without a trend
