...
If you'd also like to try local models (they're free), [install ollama and download a model](#local-models).
:::
...
-   [posit::conf(2026) Discord]({{< meta workshop.links.discord >}})
    ...
    -   Join using the [posit::conf(2026) Discord invitation]({{< meta workshop.links.discord >}}).
    -   Workshop channel: `{{< meta workshop.discord_channel >}}`
...
The link to join the Posit Cloud workspace will be posted here shortly before the workshop starts.
:::
...
When the project opens, pick your editor: **Positron** or **RStudio**.
Both work for every activity in the workshop.
...
-   **Update your R packages:**
    ...
    If you're using R, run `pak::local_install()` again to make sure you have the latest package versions.
